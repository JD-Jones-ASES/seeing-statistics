...
ax.axhline(p_exact, color='#d62728', lw=2, ls='--', label=f'counted P = {p_exact:.4f}')
ax.set_xscale('log')
...
ax.axvline(23, color='#d62728', ls='--', lw=2, label='23 people')
ax.plot(23, p_shared_birthday(23), 'o', color='#d62728', ms=7)
...
ax.plot(ks_sim, sim_curve, 'o', color='#2ca02c', ms=6, label='simulated rooms')
ax.axhline(0.5, color='grey', ls=':', lw=1)
ax.set_xlabel('number of people in the room (k)')
ax.set_ylabel('P(at least two share a birthday)')
